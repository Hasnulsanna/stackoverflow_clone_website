    ...
    <div className='home-container-1'>
       <LeftSidebar slideIn={slideIn} handleSlideIn={handleSlideIn} />
        <div className="home-container-2">
            ...
            <p className='tags-p'>A tag is a keyword or label that categorizes ypur question with other,similar questions.</p>
            <p className='tags-p'>Using the righ tags make it easier for others to find and answer your question.</p>
